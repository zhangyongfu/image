...
//                List<String> paths = uploadPubImages.getPubImgFilePath();
                    List<String> needNames = uploadPubImages.getNeedPagePubImgFileNames(pageNow);
//                Collections.reverse(paths);
                    Collections.reverse(needNames);
...
/*
        ...
        */
                    if(null !=needNames && needNames.size() != 0){
                        ...
                        for(int i =0;i<needNames.size();i++) {
                            ...
                            String imgName = needNames.get(i);

                            imgId = uploadPubImages.getPubImgId(imgName);
...
//                        Thumbnails.of(filePath).scale(1f).outputQuality(0.25f).toFile(filePath + "_quality_0.25.jpg");
                ...
                <div class="img" title="${imgName}">
                    ...
                    <div class="func_imgs" onmousemove="func1();" onmouseleave="func2()">
                        <a href="/ImageDownloadServlet?filename=${imgName}" title="下载图片">
